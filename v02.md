...
![accountdetails](https://www.dropbox.com/s/emdnluecouo44wg/cerebro%20home%20page-account%20details.png?dl=0)
...
**Home Page**
![cerebro home page-copy token.png](resources/3425CC6F6F5BD3429E4EEB5A5A2DB47E.png =1919x958)

**Quick Access Menu option** 
Click your username in the top left > 'Copy Access Token'
![cerebro menu-copy token.png](resources/FE79DD2E0FE4901DA2C5E7A34B1C66BA.png =1919x958)
...
![Cerebro Datasets Details Page - Regular + highlight.png](resources/6518533AA6A7DD1767FEA685E56ABF28.png =1919x961)
...
This page contains:
  ...
  - The dataset schema described in full
    ...
    ![Cerebro paritioning field.png](resources/C7C78B02F6E027B8F69C4C2BC17BEB03.png =145x120)
...
![Cerebro See Groups.png](resources/867E30D8DBBBF1095B3C5A9808D68482.png =989x234)
...
![Cerebro Preview Dataset.png](resources/5DB6CC99DA0D20DEAF9C7CAB895D7868.png =1919x960)
...
![Cerebro Get Started.png](resources/03CC8BB78247AEEAB3968F71EE7FD8C1.png =1917x959)
...
- A column is added to every dataset showing whether the group or groups being inspected can access any field in the dataset. 
  - ![Cerebro lock icon.png](resources/3537D4FC730C7731B52560C6E5538F69.png =35x35) - Selected Group, or set of groups, has no access to this dataset
  - ![Cerebro check icon.png](resources/CD56C394990B38B28A65CBCBAEC6805F.png =35x36) - Selected Group, or set of groups, has *some level of access* to this dataset
...
![Cerebro Datasets Details Page.png](resources/CE04A7DE2D59D4C8A48B843EFB4A02AE.png =1919x959)
...
have access to the field or not. 
  - ![Cerebro lock icon.png](resources/3537D4FC730C7731B52560C6E5538F69.png =35x35) - Group has no access to this field
  - ![Cerebro check icon.png](resources/CD56C394990B38B28A65CBCBAEC6805F.png =35x36) - Group has *some level of access* (Select or ALL) to this field. 
...
[accountdetails]: docs/AdvancedInstall.md